...
-(void) layoutFields: (CGSize) realSize offsetY:(CGFloat) yoffset{
    ...
    self.oJTitleText = [[UITextField alloc] initWithFrame:CGRectMake(originX + 20.0, 25.0 + yoffset, 72.0, 22.0)];
    ...
    self.oDescriptionText = [[UITextView alloc] initWithFrame:CGRectMake(originX + 20.0, 75.0 + yoffset, 100.0, 104.0)];
    ...
    self.oJTypeLabel = [[UILabel alloc] initWithFrame:CGRectMake(realSize.width -122.0, 25.0 + yoffset, 75.0, 22.0)];
    ...
    self.oIndustryLabel = [[UILabel alloc] initWithFrame:CGRectMake(realSize.width -122.0, 85.0 + yoffset, 75.0, 22.0)];
    ...
    self.oMorningLabel = [[UILabel alloc] initWithFrame:CGRectMake(realSize.width -175.0, 140.0 + yoffset, 75.0, 22.0)];
    ...
    self.oAfternoonLabel = [[UILabel alloc] initWithFrame:CGRectMake(realSize.width -175.0, 198.0 + yoffset, 75.0, 22.0)];
    ...
    self.oEveningLabel = [[UILabel alloc] initWithFrame:CGRectMake(realSize.width -175.0, 256.0 + yoffset, 75.0, 22.0)];
    ...
    self.oNightLabel = [[UILabel alloc] initWithFrame:CGRectMake(realSize.width -175.0, 314.0 + yoffset, 75.0, 22.0)];
    ...
    self.oMorningSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(realSize.width -66.0, 138.0 + yoffset, 0.0, 0.0)];
    ...
    self.oAfternoonSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(realSize.width -66.0, 196.0 + yoffset, 0.0, 0.0)];
    ...
    self.oEveningSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(realSize.width -66.0, 254.0 + yoffset, 0.0, 0.0)];
    ...
    self.oNightSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(realSize.width -66.0, 312.0 + yoffset, 0.0, 0.0)];
    ...
    [self.oJTypeButton setFrame: CGRectMake(realSize.width-43.0, 18.0 + yoffset, 36.0, 36.0f)];
    ...
    [self.oIndustryButton setFrame: CGRectMake(realSize.width-43.0, 78.0 + yoffset, 36.0, 36.0f)];
    ...
    [self.oPlusButton setFrame: CGRectMake(originX + 24.0, 352.0 + yoffset, 36.0, 36.0f)];
    ...
    [self.oBinButton setFrame: CGRectMake(originX + 96.0, 352.0 + yoffset, 36.0, 36.0f)];
...
- (void)actionPlus:(id)sender {
    [self.parent delegateHasSaved:(id)sender];
}

- (void)actionBin:(id)sender {
    [self.parent delegateHasCanceled:(id)sender];
}
